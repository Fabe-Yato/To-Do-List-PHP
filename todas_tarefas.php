...
<head>
    ...
    <link rel="shortcut icon" href="./imgs/list.png" type="image/x-icon">
</head>
<body>
    <nav class="navbar navbar-dark bg-dark">
        <div class="container">
            <div>
                 <img src="./imgs/list.png" width="35px">
                 <a href="#" class="navbar-brand text-white display-1">Ultimate ToDoList</a>
            </div>
        </div>
    </nav>
